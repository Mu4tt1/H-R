...
namespace H_R.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookCategoryId,BookId,CategoryId")] BookCategory bookCategory)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Books, "BookId", "Title", bookCategory.BookId);
            ViewData["CategoryId"] = new SelectList(_context.Categories, "CategoryId", "Name", bookCategory.CategoryId);
            return View(bookCategory);
        }
