...
namespace H_R.Controllers
{
    public class BooksController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["PublishingHouseId"] = new SelectList(_context.PublishingHouses, "PublishingHouseId", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Description,CoverImageUrl,PublishedDate,CategoryId,NarratorId,PublishingHouseId")] Book book)
        {
            ...
            ViewData["PublishingHouseId"] = new SelectList(_context.PublishingHouses, "PublishingHouseId", "Name", book.PublishingHouseId);
            return View(book);
        }
